...
# Avatars
USER_AVATAR = "https://api.dicebear.com/7.x/notionists-neutral/svg?seed=Felix&backgroundColor=e5e7eb"
AI_AVATAR = "https://api.dicebear.com/7.x/bottts-neutral/svg?seed=ScraperBot&backgroundColor=ffedd5"
...
with col2:
    ...
    st.markdown('<div class="custom-selectbox"></div>', unsafe_allow_html=True)
        ...
        def update_progress(curr, count, total):
            ...
            <div class="progress-container">
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.75rem;">
                    <span style="font-weight: 600; color: #1e293b;">Processing Content...</span>
